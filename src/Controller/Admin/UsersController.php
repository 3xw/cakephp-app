...
class UsersController extends CakeDCUsersController
{
  ...
  public function view($id = null)
  {
    $user = $this->Users->get($id,['contain' => [
      'ActiveUsersLicences' => ['Licences'],
      'UnactiveUsersLicences',
      'Transactions' => ['Invoices'],
      'Lessons' => ['Locations','LessonTypes']
      ]]);
    ...
    */
    ...
    {
      $query = $this->Users->find('search', ['search' => $this->getRequest()->getQuery()])
      ->contain([
        'ActiveUsersLicences',
        'UnactiveUsersLicences',
        'UpcomingLessons',
        'PastLessons',
        'Transactions',
        'UsersComponents' => ['Components','Modules']
      ]);
    ...
    public function add()
    {
      ...
      {
        if ($userSaved = $this->Users->registerFromAdmin($user, $this->getRequest()->getData()))
        {
          $this->Flash->success(__('The user has been saved.'));
          $this->Flash->success(__('Password is:')." $user->originalPassword");
      ...
      $lessons = $this->Users->Lessons->find('list');
      $licences = $this->Users->Licences->find('list');

      $this->set(compact('user','lessons','licences'));
      $this->set('_serialize', ['user']);
    ...
    public function edit($id = null)
    {
      $user = $this->Users->get($id,[
        'contain' => ['Attachments','Licences','Lessons']
      ]);
